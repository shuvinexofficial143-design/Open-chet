...
export type Data={organization_id:string;user_id:string;role:Role;contacts:Contact[];conversations:Conversation[];messages:Message[];notes:Row[];templates:Row[];quick_replies:Row[];products:Row[];campaigns:Row[];campaign_recipients:Row[];automation_rules:Row[];members:Row[];audit_logs:Row[];notifications:Row[];settings:Settings;connection?:{whatsapp:boolean;ai:boolean;whatsapp_accounts:WhatsAppConnection[]};has_more?:boolean};
